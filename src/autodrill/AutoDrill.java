...
public class AutoDrill extends Mod {
    ...
    public void init() {
        ...
        Cons < SettingsMenuDialog.SettingsTable > builder = settingsTable -> {
            ...
            settings.pref(new DividerSetting());
            settings.pref(new DescriptionSetting("\uF74D Автоматизация угольных генераторов"));
            settings.checkPref("autodrill-build-generators", false);
            settings.checkPref("autodrill-use-steam-generators", false);
